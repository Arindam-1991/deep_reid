...
class PreTrainer(object):
    def __init__(self, model, criterion, optimizer, datamanager, num_epochs=1, max_steps=2000, num_trials=10):
        super().__init__()
        self.model = model
        self.criterion = criterion
        self.optimizer = optimizer
        self.data_loader = datamanager.train_loader
            ...
            for i, inputs in enumerate(self.data_loader):
                ...
                print('Trial {}: epoch [{}][{}/{}]. '
                    ...
                    .format(trial + 1, ep, i + 1, min(self.max_steps, len(self.data_loader)),
                            ...
                            precisions.val, precisions.avg), end='\r')
